...
class WorkpaneTest extends WorkpaneTestCase {
	...
	void testAddToolAllocateCheck() {
		...
		Assertions.assertTrue( workpane.getTools().contains( tool ) );
	...
	void testAddRemoveToolEvents() {
		...
		MatcherAssert.assertThat( tool.getToolView().getActiveTool(), is( tool ) );
		...
		MatcherAssert.assertThat( tool.getToolView(), is( nullValue() ) );
	...
	void testAddSelectRemoveToolEvents() {
		MockTool tool = new MockTool( asset );
		MatcherAssert.assertThat( workpane.getActiveTool(), is( nullValue() ) );
	...
	@Test
	void testDockMode() {
		MatcherAssert.assertThat( workpane.getDockMode(), Matchers.is( Workpane.DEFAULT_DOCK_MODE ) );

		workpane.setDockMode( Workpane.DockMode.PORTRAIT );
		MatcherAssert.assertThat( workpane.getDockMode(), is( Workpane.DockMode.PORTRAIT ) );

		workpane.setDockMode( Workpane.DockMode.LANDSCAPE );
		MatcherAssert.assertThat( workpane.getDockMode(), is( Workpane.DockMode.LANDSCAPE ) );

		workpane.setDockMode( Workpane.DEFAULT_DOCK_MODE );
		MatcherAssert.assertThat( workpane.getDockMode(), is( Workpane.DEFAULT_DOCK_MODE ) );
	}
	...
	void testSplitNorth() {
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( Workpane.DEFAULT_WALL_SPLIT_RATIO ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
	}
	...
	void testSplitSouth() {
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1 - Workpane.DEFAULT_WALL_SPLIT_RATIO ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
	}
	...
	void testSplitWest() {
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( Workpane.DEFAULT_WALL_SPLIT_RATIO ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
	}
	...
	void testSplitEast() {
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1 - Workpane.DEFAULT_WALL_SPLIT_RATIO ) );
	}
	...
	void testSplitNorthCompound() {
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( Workpane.DEFAULT_VIEW_SPLIT_RATIO ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
	...
	void testSplitEastCompound() {
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( Workpane.DEFAULT_VIEW_SPLIT_RATIO ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
	...
	void testSplitViewNorthWithSize() {
		...
		assertThat( view1.getEdge( Side.TOP ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( view1.getEdge( Side.BOTTOM ).getPosition(), Matchers.is( workpane.getTopDockSize() ) );
		assertThat( view1.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		assertThat( view1.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );

		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), Matchers.is( workpane.getTopDockSize() ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( position ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
	}
	...
	void testSplitViewSouth() {
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1 - Workpane.DEFAULT_VIEW_SPLIT_RATIO ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
	...
	void testSplitViewSouthWithSize() {
		...
		assertThat( view1.getEdge( Side.TOP ).getPosition(), Matchers.is( 1 - workpane.getBottomDockSize() ) );
		assertThat( view1.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		assertThat( view1.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		assertThat( view1.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );

		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), Matchers.is( 1 - workpane.getBottomDockSize() ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( position ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
	}
	...
	void testSplitViewWestWithSize() {
		...
		assertThat( view1.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		assertThat( view1.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( view1.getEdge( Side.RIGHT ).getPosition(), Matchers.is( workpane.getLeftDockSize() ) );

		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), Matchers.is( workpane.getLeftDockSize() ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( position ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );
	}
	...
	void testSplitViewEast() {
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( 1 - Workpane.DEFAULT_VIEW_SPLIT_RATIO ) );
	...
	void testSplitViewEastWithSize() {
		...
		assertThat( view1.getEdge( Side.TOP ).getPosition(), is( 0d ) );
		assertThat( view1.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		assertThat( view1.getEdge( Side.LEFT ).getPosition(), Matchers.is( 1 - workpane.getRightDockSize() ) );
		assertThat( view1.getEdge( Side.RIGHT ).getPosition(), is( 1d ) );

		MatcherAssert.assertThat( toolview.getEdge( Side.TOP ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), Matchers.is( 1 - workpane.getRightDockSize() ) );
		...
		MatcherAssert.assertThat( toolview.getEdge( Side.BOTTOM ).getPosition(), is( 1d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.LEFT ).getPosition(), is( 0d ) );
		MatcherAssert.assertThat( toolview.getEdge( Side.RIGHT ).getPosition(), is( position ) );
	}
