...
public class CatalogCardTest {
	...
	public void testReadCardFromYaml() throws Exception {
		...
		products.add( URI.create( "http://www.xeomar.com/download/product/xenon/card" ) );
		...
		assertThat( card.getIcon(), is( URI.create( "http://www.xeomar.com/download/image/xeomar.png" ) ) );
