...
//		Log.write( Log.DETAIL, "Resource type: ", type );
//
...
//		}
//		Log.write( Log.DETAIL, "Resource codec: ", codec );
//
//		// Initialize the resource.
//		if( !type.resourceDefault( program, resource ) ) return false;
//		Log.write( Log.DETAIL, "Resource initialized with default values." );
//
...
//			Log.write( Log.DETAIL, "Resource initialized with user values." );
//		}
//
//		// Open the resource.
//		resource.open();
...
//
//		Log.write( Log.TRACE, "Resource opened: " + resource );
//
//		program.getEventBus().submit( new ResourceOpenedEvent( getClass(), resource ) );
//
//		return true;
//	}
//
