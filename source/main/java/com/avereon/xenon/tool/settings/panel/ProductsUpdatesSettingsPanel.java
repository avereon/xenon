...
import com.avereon.xenon.tool.settings.panel.products.RefreshUpdatableProducts;
...
public class ProductsUpdatesSettingsPanel extends ProductsSettingsPanel {
	...
	protected void updateState( boolean force ) {
		...
		getProgram().getTaskManager().submit( new RefreshUpdatableProducts( this, force ) );
	}
