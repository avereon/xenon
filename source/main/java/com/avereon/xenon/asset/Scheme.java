...
public interface Scheme {
	 ...
	 */
	default List<Asset> getRoots() throws ResourceException {
		return List.of();
	}
	 ...
	 * @throws ResourceException If an error occurs
	 */
	default boolean canLoad( Asset asset ) throws ResourceException {
		return false;
	}
	 ...
	 * @throws ResourceException If an error occurs
	 */
	default boolean canSave( Asset asset ) throws ResourceException {
		return false;
	}
	 ...
	 * @throws ResourceException If an error occurs
	 */
	default void init( Asset asset ) throws ResourceException {}
	 ...
	 * @throws ResourceException If an error occurs
	 */
	default void open( Asset asset ) throws ResourceException {}
	 ...
	 * @throws ResourceException If an error occurs
	 */
	default void load( Asset asset, Codec codec ) throws ResourceException {}
	 ...
	 * @throws ResourceException If an error occurs
	 */
	default void save( Asset asset, Codec codec ) throws ResourceException {}
	 ...
	 * @throws ResourceException If an error occurs
	 */
	default void close( Asset asset ) throws ResourceException {}
	 ...
	 */
	default boolean exists( Asset asset ) throws ResourceException {
		return false;
	}
	 ...
	 */
	default boolean create( Asset asset ) throws ResourceException {
		return false;
	}
	 ...
	 * @throws ResourceException If an error occurs during the operation
	 */
	default boolean createFolder( Asset asset ) throws ResourceException {
		return false;
	}
	 ...
	 */
	default void saveAs( Asset asset, Asset target ) throws ResourceException {}
	 ...
	 */
	default boolean rename( Asset asset, Asset target ) throws ResourceException {
		return false;
	}
	 ...
	 */
	default boolean delete( Asset asset ) throws ResourceException {
		return false;
	}
	 ...
	 */
	default boolean isFolder( Asset asset ) throws ResourceException {
		return false;
	}
	 ...
	 */
	default boolean isHidden( Asset asset ) throws ResourceException {
		return false;
	}
	 ...
	 */
	default List<Asset> listAssets( Asset asset ) throws ResourceException {
		return List.of();
	}
	 ...
	 */
	default long getSize( Asset asset ) throws ResourceException {
		return -1;
	}
	 ...
	 */
	default long getModifiedDate( Asset asset ) throws ResourceException {
		return -1;
	}
