...
public class ThemeWriter {
	...
	private void printExBackgrounds( PrintWriter printer ) {
		...
		printer.println( "  -ex-background-text: " + format( base.deriveColor( 0, 1, 1, 0.35 ) ) + ";" );
		printer.println( "  -ex-background-tabs: " + format( base.deriveColor( 0, 1, 1, 0.5 ) ) + ";" );
		printer.println( "  -ex-background-tags: " + format( base.deriveColor( 0, 1, 1, 0.65 ) ) + ";" );
