...
//			setView( settings, VIEW_ACTIVE, pane::setActiveView );
//			setView( settings, VIEW_DEFAULT, pane::setDefaultView );
//			setView( settings, VIEW_MAXIMIZED, pane::setMaximizedView );
//		}
//	}
//
...
//		if( view != null ) {
//			handler.accept( view );
//		} else if( VIEW_DEFAULT.equals( key ) ) {
